...
const CHAKRA := preload("res://ChakraPetch-Regular.ttf")
const CHAKRA_SEMIBOLD := preload("res://ChakraPetch-SemiBold.ttf")
const TITLE_FONT := preload("res://Dark Distance.otf")
...
func start_game() -> void:
	...
	if not gameplay_is_ready:
		...
		return
	transition_layer.reparent(get_tree().root)
